...
class TestInlineMarkdown(unittest.TestCase):
    ...
    def test_split_nodes_delimiter_multiword(self):
        node = TextNode(
            "This is text with a **bolded word** and **another**", text_type_text
        )
        new_nodes = split_nodes_delimiter([node], "**", text_type_bold)
    ...
    def test_split_nodes_delimiter_no_delimiter(self):
        node = TextNode("This is text without any delimiter", text_type_text)
        new_nodes = split_nodes_delimiter([node], "**", text_type_bold)
        self.assertListEqual(
            [
                TextNode("This is text without any delimiter", text_type_text),
            ],
            new_nodes,
        )
    
    def test_split_nodes_delimiter_invalid_delimiter(self):
        node = TextNode("This is text with an invalid delimiter", text_type_text)
